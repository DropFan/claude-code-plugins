...
| `stop_hook` | `true` \| `false` | `true` | Enable session-end suggestions to save conversation |
| `stop_hook_threshold` | integer | `50` | Scoring threshold for the stop hook to suggest saving (higher = less frequent suggestions) |
