...
| [skill-extractor](./plugins/skill-extractor) | Extract reusable skills, commands, and agents from conversation history | [Tiger](https://github.com/DropFan) | `/plugin install skill-extractor@tiger-plugins` | 0.1.0 |
<!-- PLUGINS_TABLE_END -->
