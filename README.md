...
| [lark](./plugins/lark) | Operate Feishu/Lark (IM, Docs, Base, Sheets, Calendar, Drive, Wiki, Task, OKR, VC, etc.) via the local lark-cli. Mirrors the Claude Code lark skill set for Cowork. 飞书/Lark 全套技能。 | [Tiger](https://github.com/DropFan) | `/plugin install lark@tiger-plugins` | 1.0.48 |
